...
export async function POST(request: Request) {
  try {
    ...
    const novaTriagem: TriagemPacienteRecord = {
      ...
      idade: body.idade || undefined,
      email: body.email,
      cpf: body.cpf,
      cep: body.cep,
      numeroResidencia: body.numeroResidencia || undefined,
      ...
      paraQuemE: body.paraQuemE || undefined,
      especificarNecessidades: Boolean(body.especificarNecessidades),
      necessidadesPaciente: Array.isArray(body.necessidadesPaciente) ? body.necessidadesPaciente : [],
      necessidadesOutro: body.necessidadesOutro || undefined,
      opcaoAvaliacaoPsicologica: body.opcaoAvaliacaoPsicologica || undefined,
